    ...
    <section class="card w-100">
      <div class="card_header">
        ...
        <select class="form_control">
          ...
          <option value="1">Jessica Guadalupe Hernández Rodriguez</option>
          <option value="2">Marco Antonio Hernández Rodriguez</option>
          <option value="3">Enrique Carranza Balderas</option>
          <option value="4">Juan Manuel Butista Soto</option>
        </select>
      </div>
    </section>
...
<script setup>
  ...
  const calendarOptions = {
    ...
    headerToolbar: {
      start: options.value.headerToolbar.start,
      center: options.value.headerToolbar.center,
