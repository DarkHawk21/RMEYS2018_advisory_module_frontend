  ...
  <section class="modal_wrap">
    <div class="modal">
      <div class="modal_header">
        <i class="fa-solid fa-xmark" @click="$emit('hideModalEditRecurrence')"></i>
      </div>
      ...
      <div class="modal_footer">
        <button class="btn bg_red" @click="$emit('hideModalEditRecurrence')">Cancelar</button>
        <button class="btn" @click="$emit('saveEventEditRecurrence')">Guardar</button>
      </div>
    </div>
  </section>
</template>
